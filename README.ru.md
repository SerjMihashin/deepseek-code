...
- **Browser tools**: Chrome-проверки UI, console errors, forms и network behavior — с текстовым «восприятием» (`observe`/`dom`), без vision. В headed-режиме визуальный слой (неоновая рамка, светящийся курсор, рябь клика, HUD действия) показывает, что делает агент.
