...
const EN: LocaleStrings = {
  ...
  next: 'next step',
  noApiKey: '[warn] API key not configured',
  ...
  apiKeySet: '[ok] API key saved! You can now use DeepSeek Code.',
  apiKeyInvalid: '[err] Invalid API key format. Key should start with "sk-".',
...
const RU: LocaleStrings = {
  ...
  next: 'далее',
  noApiKey: '[warn] API-ключ не настроен',
  ...
  apiKeyPlaceholder: 'sk-...',
  apiKeySet: '[ok] API-ключ сохранён! Теперь вы можете использовать DeepSeek Code.',
  apiKeyInvalid: '[err] Неверный формат ключа. Ключ должен начинаться с "sk-".',
...
const ZH: LocaleStrings = {
  ...
  apiKeyPlaceholder: 'sk-...',
  apiKeySet: '[ok] API 密钥已保存！您现在可以使用 DeepSeek Code。',
  apiKeyInvalid: '[err] 密钥格式无效。密钥应以 "sk-" 开头。',
  setupSettings: '设置',
  selectTheme: '选择主题:',
  selectMode: '选择审批模式:',
